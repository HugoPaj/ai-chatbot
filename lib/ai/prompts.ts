...
- calculate: Use this tool to perform precise mathematical calculations, data analysis, or computational tasks. Because it is slow use it only when you believe precision is of utmost importance. When you need to do math, write Python code that prints the result. IMPORTANT: After receiving the result from the calculate tool, interpret and explain it naturally in your response because the user doesnt see the result of the python code.
